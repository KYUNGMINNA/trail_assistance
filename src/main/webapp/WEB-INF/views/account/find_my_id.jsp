	...
	<div id="loginbox" style="margin-top: 50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
		<div class="panel panel-info">
			...
			<div style="padding-top: 30px" class="panel-body">
				...
				<form action="<c:url value="/account/find_my_id_result" />" method="POST" id="loginform" class="form-horizontal" role="form">
...
<script>
	...
	$(function() {
		...
		$('#user_email_check_btn').click(function() {
			...
			$.ajax({
					type: 'POST', 
					url: '<c:url value="/account/checkIdByEmail"/>', 
			...
			if (chk2) {
				...
				$.ajax({
					type: 'POST', 
					url: '<c:url value="/account/checkEmail"/>', 
					contentType: 'application/json',
					dataType: 'text', 
					data: email,
		...
		$('#next_page').click(function() {
			...
			if (chk1 && chk2 && chk3) {
				...
				$.ajax({
					type: 'POST', 
					url: '/myweb/account/selectIdByEmail', 
					contentType: 'application/json',
					dataType: 'text', 
					data: email,
					success: function() {
