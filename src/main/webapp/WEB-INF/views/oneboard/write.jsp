						...
						<table class="table">
							<tbody class="t-control">
								...
								<tr>
									...
									<td><input type="text" class="form-control input-sm" name="one_writer" value="${login.account}" readonly></td>
								</tr>

								<tr>
									<td class="t-title">문의 제목 *</td>

									<td><input type="text" class="form-control input-sm" id="title" name="one_title"></td>
								</tr>

								<tr>
									<td class="t-title">문의 유형 *</td>

									<td><select class=" form-control input-sm sel" name="one_cate_one">
											<option>계정 분실</option>
											<option>이용 문의</option>
											<option>건의 사항</option>
								...
								<tr>
									...
									<td><textarea class="form-control" rows="10" id="content" name="one_content" style="resize: none;"></textarea></td>
								</tr>
